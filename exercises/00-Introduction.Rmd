...
```{r}
# If you haven't installed the tidyverse package do so now
# If you already isntalled it all you need to do is load it
...
```{r}
# Let's make sure we have all the other packages installed as well
packages_needed <- c("babynames", "formatR", "gapminder", "hexbin", "mgcv", "maps", "mapproj", "nycflights13", "tidyverse", "viridis")
packages_to_install <-setdiff(packages_needed,installed.packages())
